...
public class OptionIsland {
    ...
    public static int eagle =2;
    public static int horse =2;
    public static int deer =2;
    public static int rabbit =2;
    public static int mouse =2;
    public static int goat =2;
    public static int sheep =2;
    public static int boar =2;
    public static int buffalo =2;
    public static int duck =2;
    public static int caterpillar =2;
